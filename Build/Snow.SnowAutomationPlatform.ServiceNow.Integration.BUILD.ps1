...
Set-Location ..
$BuildRoot = '.'
$Script:ModuleName = 'Snow.SnowAutomationPlatform.ServiceNow.Integration'
$Script:IsAppveyor = $null -ne $env:APPVEYOR

Get-Module -Name $ModuleName,'Snow.SnowAutomationPlatform.ServiceNow.Integration.BUILDHELPERS' | Remove-Module -Force
Import-Module "$BuildRoot\build\Snow.SnowAutomationPlatform.ServiceNow.Integration.BUILDHELPERS.psm1"
